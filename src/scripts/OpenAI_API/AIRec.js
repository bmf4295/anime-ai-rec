...
const getAIRecommendation = async (FavoriteAnimeTitle) => {
    ...
    const response = await client.responses.create({
        model: "gpt-4o",
        instructions: "You are an expert anime recommender. Every time you will suggest exactly 6 anime based on the favorite anime that is given by the user. Give a good mix of popular and less well known anime, and do not recommend another season of the same show if it exists. If you recieve the same query more than once from the same user, please try and recommend at least 1 thing different from the last request. Please provide ONLY the english titles of 6 anime in an comma seperated list, without any other text.",
